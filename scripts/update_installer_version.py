...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TestWaveVisualizer Demo Installer\n"
      else:
        line="OutputBaseFilename=TestWaveVisualizer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TestWaveVisualizer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TestWaveVisualizer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TestWaveVisualizer Demo installer\n"
     else:
       line="SetupWindowTitle=TestWaveVisualizer installer\n"
