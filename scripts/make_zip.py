...
def  main():
  ...
  installer = "\installer\TestWaveVisualizer Installer.exe"
   
  if demo:
    installer = "\installer\TestWaveVisualizer Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\TestWaveVisualizer manual.pdf" 
  ]
  ...
  ZIPNAME = "TestWaveVisualizer-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "TestWaveVisualizer-v" + FULLVERSIONSTR + "-win-demo.zip"
