...
def main():
  ...
  plistpath = scriptpath + "/resources/TestWaveVisualizer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestWaveVisualizer-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestWaveVisualizer-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestWaveVisualizer-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/TestWaveVisualizer-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/TestWaveVisualizer.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/TestWaveVisualizer.iss",inplace=1):
